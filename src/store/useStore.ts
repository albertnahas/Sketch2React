        ...
        const messages = [
          {
            role: "system",
            content: `
You are a UI code assistant. Given a Konva-stage JSON of shapes and text, infer a meaningful modern stylish user interface layout:

• Rectangles become containers or buttons or paragraphs.  
